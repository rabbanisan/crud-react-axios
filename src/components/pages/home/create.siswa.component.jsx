        ...
        <Container className="flex flex-col md:flex-row items-center">
          ...
          <div className="jumboText w-8/12 md:w-6/12 ">
            ...
            <p className="14px text-[12px] sm:text-[14px] md:text-[20px] xl:text-[28px]">
              Selamat datang di Sistem Informasi Siswa, kamu bisa melihat seluruh siswa pada daftar siswa dan mengelola data mulai dari menambah data siswa, menghapus data siswa dan merubah data siswa
            </p>
          </div>
